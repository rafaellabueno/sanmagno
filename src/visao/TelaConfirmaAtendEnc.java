...
public class TelaConfirmaAtendEnc extends JPanel {
	...
	public TelaConfirmaAtendEnc() {
		...
		lblConfirma = new JLabel(new ImageIcon(TelaConfirmaAtendEnc.class.getResource("/img/atendence.png")));
		lblConfirma.setText("");
