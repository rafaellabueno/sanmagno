...
public class TelaTriagem extends JPanel {
	...
	public TelaTriagem() {
		...
		JLabel lblSelecioneAPrioridade = new JLabel(
				"Selecione as informa\u00E7\u00F5es que correspondem o(a) paciente:");
		...
		btnProxPac = new JButton("Próximo Paciente");
		btnProxPac.setEnabled(false);
		btnProxPac.setFont(new Font("Tahoma", Font.PLAIN, 14));
		add(btnProxPac, "cell 0 9,alignx left");
	...
	public JButton getBtnProxPac() {
		return btnProxPac;
	}

	public void setBtnProxPac(JButton btnProxPac) {
		this.btnProxPac = btnProxPac;
	}
	...
	// botao de próximo paciente só é liberado depois de calcular prioridade
	public void botaoProxPac() {
		btnProxPac.setEnabled(true);
	}

	// botao de próximo paciente é ocultado quando não calculada prioridade
	public void botaoProxPacDesabilitar() {
		btnProxPac.setEnabled(false);
	}

	// botao da prioridade é desabilitado depois que calculada prioridade
	public void botaoPrioridade() {
		btnPrioridade.setEnabled(false);
	}
	
	// botao da prioridade é habilitado
	public void botaoPrioridadeHabilitar() {
		btnPrioridade.setEnabled(true);
	}
